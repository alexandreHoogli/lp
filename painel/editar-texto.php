                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="form-body">
                                        <h4 class="card-title">Segunda Seção - ícones <small>(Para adicionar um novo bloco com ícone, dirija-se ao menu lateral "Ícones")</small></h4>
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12">
                                                <label  class="col-form-label">Título</label>
                                                <input class="form-control" type="text" name="breve" value="<?php if(isset($editaTexto->breve) && !empty($editaTexto->breve)){ echo $editaTexto->breve;}?>" />
                                            </div>
                                        </div>
                                        <hr>
                                        <br>
                                        <h4 class="card-title">Terceira Seção - Conteúdo & Vídeo</h4>
                                        ...
                                        <div class="row">
                                             <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="mr-sm-2" for="">Imagem (648x300)</label>
                                        ...
                                        <br>
                                         <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="mr-sm-2" for="">Título ao lado do play</label>
                                        ...
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Quarta Seção - Conteúdo & Vídeo</h4>
                                        <div class="row">
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Subtítulo</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <?php if(isset($editaTexto->foto_7) && !empty($editaTexto->foto_7)){ ?>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <img src="../img/<?php echo $editaTexto->foto_7;?>" width="100" alt="">
                                                    </div>
                                                </div>
                                            <?php }?> 
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="mr-sm-2" for="">Embed <small>(Caso tenha vídeo ex: "https://www.youtube.com/watch?v=k8BAmTCrx7s")</small></label>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="mr-sm-2" for="">Título ao lado do play</label>
                                                    <input type="text" class="form-control" name="breve2" value="<?php if(isset($editaTexto->breve2) && !empty($editaTexto->breve2)){ echo $editaTexto->breve2;}?>" >
                                                </div> 
                                            </div>
                                        </div>
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Quinta Seção - Conteúdo & Vídeo</h4>
                                        <div class="row">
                                            <div class="col-lg-7">
                                                <div class="form-group">
                                                    <label class="mr-sm-2" for="">Subtítulo</label>
                                             ...
                                             <div class="col-lg-7">
                                                <div class="form-group">
                                                    <label class="mr-sm-2" for="">Título</label>
                                                    <input type="text" class="form-control" name="breve3" value="<?php if(isset($editaTexto->breve3) && !empty($editaTexto->breve3)){ echo $editaTexto->breve3;}?>" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <?php if(isset($editaTexto->foto_4) && !empty($editaTexto->foto_4)){ ?>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <img src="../img/<?php echo $editaTexto->foto_4;?>" width="100" alt="">
                                                    </div>
                                                </div>
                                            <?php }?> 
                                             <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <label  class="col-form-label">Título ao lado do play</label>
                                        ...
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Sexta Seção - Conteúdo & Vídeo</h4>
                                        <div class="row">
                                            <div class="col-md-7 col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php if(isset($editaTexto->foto_6) && !empty($editaTexto->foto_6)){ ?>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <img src="../img/<?php echo $editaTexto->foto_6;?>" width="100" alt="">
                                                    </div>
                                                </div>
                                            <?php }?> 
                                            <div class="col-md-12">
                                        ...
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Sétima Seção - Conteúdo & Vídeo</h4>
                                         <div class="row">
                                              <div class="col-md-7 col-sm-12">
                                                <label  class="col-form-label">Subtítulo</label>
                                                <input class="form-control" type="text" name="breve6" value="<?php if(isset($editaTexto->breve6) && !empty($editaTexto->breve6)){ echo $editaTexto->breve6;}?>" />
                                            </div>
                                             <div class="col-md-7 col-sm-12">
                                                <label  class="col-form-label">Título</label>
                                                <input class="form-control" type="text" name="breve4" value="<?php if(isset($editaTexto->breve4) && !empty($editaTexto->breve4)){ echo $editaTexto->breve4;}?>" />
                                            </div>
                                        </div>
                                        <br>
                                         <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <label  class="col-form-label">Legenda Imagem</label>
                                                <input class="form-control" type="text" name="breve7" value="<?php if(isset($editaTexto->breve7) && !empty($editaTexto->breve7)){ echo $editaTexto->breve7;}?>" />
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                <label  class="col-form-label">Embed <small>(Caso tenha vídeo ex: "https://www.youtube.com/watch?v=k8BAmTCrx7s")</small></label>
                                                <input class="form-control" type="text" name="breve10" value="<?php if(isset($editaTexto->breve10) && !empty($editaTexto->breve10)){ echo $editaTexto->breve10;}?>" />
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <label  class="col-form-label">Título ao lado do play</label>
                                                <input class="form-control" type="text" name="breve11" value="<?php if(isset($editaTexto->breve11) && !empty($editaTexto->breve11)){ echo $editaTexto->breve11;}?>" />
                                            </div>
                                        </div>
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Otiva Seção - Conteúdo & Vídeo</h4>
                                        <div class="row">
                                             <div class="col-lg-7">
                                                <div class="form-group">
                                                    <label class="mr-sm-2" for="">Subtítulo</label>
                                            ...
                                            <div class="col-lg-7">
                                                <div class="form-group">
                                                    <label class="mr-sm-2" for="">Título</label>
                                                    <input type="text" class="form-control" name="breve15" value="<?php if(isset($editaTexto->breve15) && !empty($editaTexto->breve15)){ echo $editaTexto->breve15;}?>" >
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Nona Seção - Poscast</h4>
                                        <div class="row">
                                            <div class="col-md-7 col-sm-12">
                                                <label  class="col-form-label">Subtítulo</label>
                                            ...
                                            <div class="col-md-7 col-sm-12">
                                                <label  class="col-form-label">Título Esquerda</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Imagem Desktop (1191x468)</label>
                                            ...
                                            <?php if(isset($editaTexto->foto_10) && !empty($editaTexto->foto_10)){ ?>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <img src="../img/<?php echo $editaTexto->foto_10;?>" width="150" alt="">
                                                    </div>
                                                </div>
                                            <?php }?> 
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="mr-sm-2" for="">Imagem mobile (450x750)</label>
                                        ...
                                        <div class="row">
                                             <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                            <label class="mr-sm-2" for="">Ícone 1 (52x78)</label>
                                                    ...
                                                    <?php if(isset($editaTexto->foto_13) && !empty($editaTexto->foto_13)){ ?>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <img src="../img/<?php echo $editaTexto->foto_13;?>" width="65" alt="">
                                                            </div>
                                                        </div>
                                                    <?php }?> 
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <label class="mr-sm-2" for="">Título</label>
                                                            <input type="text" class="form-control" name="breve8" value="<?php if(isset($editaTexto->breve8) && !empty($editaTexto->breve8)){ echo $editaTexto->breve8;}?>" >
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                            <label class="mr-sm-2" for="">Ícone 2 (52x78)</label>
                                                    ...
                                                    <?php if(isset($editaTexto->foto_14) && !empty($editaTexto->foto_14)){ ?>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <img src="../img/<?php echo $editaTexto->foto_14;?>" width="60" alt="">
                                                            </div>
                                                        </div>
                                                    <?php }?> 
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <label class="mr-sm-2" for="">Título</label>
                                                            <input type="text" class="form-control" name="breve9" value="<?php if(isset($editaTexto->breve9) && !empty($editaTexto->breve9)){ echo $editaTexto->breve9;}?>" >
                                                        </div>
                                                    </div>
                                        ...
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Décima Seção - Planos <small>(Para adiconar/editar algum plano dirija-se ao menu lateral)</small></h4>
                                         <div class="row">
                                            <div class="col-md-7 col-sm-12">
                                                <label  class="col-form-label">Subtítulo</label>
                                        ...
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Sexta Seção - Tabela de Valores </h4>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Imagem de fundo (1920x852)</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Imagem (500x450)</label>
                                        ...
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Sétima Seção - Imagens</h4>
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                        <label class="mr-sm-2" for="">Imagem 1 (500x500)</label>
                                                    ...
                                                    <?php if(isset($editaTexto->foto_9) && !empty($editaTexto->foto_9)){ ?>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <img src="../img/<?php echo $editaTexto->foto_9;?>" width="90" alt="">
                                                            </div>
                                                        </div>
                                                    <?php }?> 
                                                     <div class="col-md-12 col-sm-12">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                        <label class="mr-sm-2" for="">Imagem 2 (500x500)</label>
                                                    ...
                                                    <?php if(isset($editaTexto->foto) && !empty($editaTexto->foto)){ ?>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <img src="../img/<?php echo $editaTexto->foto;?>" width="90" alt="">
                                                            </div>
                                                        </div>
                                                    <?php }?> 
                                                    <div class="col-md-12 col-sm-12">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                        <label class="mr-sm-2" for="">Imagem 3 (500x500)</label>
                                                    ...
                                                    <?php if(isset($editaTexto->foto_5) && !empty($editaTexto->foto_5)){ ?>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <img src="../img/<?php echo $editaTexto->foto_5;?>" width="90" alt="">
                                                            </div>
                                                        </div>
                                                    <?php }?> 
                                                     <div class="col-md-12 col-sm-12">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                            <label class="mr-sm-2" for="">Imagem 4 (500x500)</label>
                                                    ...
                                                    <?php if(isset($editaTexto->foto_15) && !empty($editaTexto->foto_15)){ ?>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <img src="../img/<?php echo $editaTexto->foto_15;?>" width="90" alt="">
                                                            </div>
                                                        </div>
                                                    <?php }?> 
                                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                            <label class="mr-sm-2" for="">Ícone (50x50)</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                            <label class="mr-sm-2" for="">Ícone (75x75)</label>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <label class="mr-sm-2" for="">Título</label>
                                                            <input type="text" class="form-control" name="titulo14" value="<?php if(isset($editaTexto->titulo14) && !empty($editaTexto->titulo14)){ echo $editaTexto->titulo14;}?>" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Nona Seção - Perguntas Frequentes <small>(Para adiconar mais perguntas dirija-se ao menu lateral FAQ e selecione Seção 2)</small> </h4>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Imagem de fundo (1920x1080)</label>
                                        ...
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Décima Seção - Contato</h4>
                                         <div class="row">
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Título</label>
                                            ...
                                            <div class="col-lg-7">
                                                <div class="form-group">
                                                    <label class="mr-sm-2" for="">Título Formulário</label>
