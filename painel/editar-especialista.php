...
<head>
    ...
    <title>Painel Hoogli - Editar Plano</title>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page"><a href="especialistas.php" class="text-muted">Planos</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
