                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if ($faq->faq === '1') {echo'Seção 1';} elseif ($faq->faq === '2'){echo 'Seção 2';}elseif ($faq->faq === '3'){echo 'Seção 3';}elseif ($faq->faq === '4'){echo 'Seção 4';}elseif ($faq->faq === '5'){echo 'Seção 5';}elseif ($faq->faq === '6'){echo 'Seção 6';};?></td>
                                                <td>
