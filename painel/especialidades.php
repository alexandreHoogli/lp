...
<head>
    ...
    <title>Painel Hoogli - ícones</title>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">ícones</h4>
                    ...
                    <div class="col-5 align-self-center">
                        <a href="add-especialidade.php" class="btn btn-success float-right m-1">Add. ícone</a>
                    </div>
                </div>
            </div>
