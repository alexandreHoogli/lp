                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <h4 class="card-title">Primeira Seção abaixo do Banner</h4>
                                        ...
                                        <hr>
                                        <br>
                                        <h4 class="card-title">Segunda Seção - FAQ & Vídeo</h4>
                                        <div class="row">
                                             <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Imagem de Fundo (1920x970)</label>
                                        ...
                                        <div class="row">
                                             <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="mr-sm-2" for="">Thumbnail (648x570)</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Legenda Thumb</label>
                                        ...
                                        <hr>
                                        <br>
                                        <h4 class="card-title">Terceira Seção - Antes e Depois</h4>
                                        <div class="row">
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Subtítulo</label>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                            <label class="mr-sm-2" for="">Imagem (597x328)</label>
                                        ...
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Quarta Seção - ícones <small>(Para adicionar um novo bloco com ícone, dirija-se ao menu lateral "Ícones")</small></h4>
                                        <div class="row">
                                             <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Imagem de fundo (1920x1027)</label>
                                        ...
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Quinta Seção - Suporte ao franqueado </h4>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Imagem (550x290)</label>
                                        ...
                                        <div class="row">
                                             <div class="col-md-7 col-sm-12">
                                                <label  class="col-form-label">Título Central</label>
                                        ...
                                        <br>
                                        <hr>
                                        <h4 class="card-title">Oitava Seção - Passo a Passo</h4>
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    <label class="mr-sm-2" for="">Título </label>
